...
STRINGS = {
    "en": {
        ...
        # steps + welcome
        "steps_title": "\n*Step-by-step:*\n",
        "walk_to": "🚶 Walk/ride ~{d} km to *{s}*",
        "board_rail": "🚆 Board *{line}* toward *{toward}*",
        "ride_stops": "↳ Ride {n} stops: {stops}",
        "alight": "⏹ Alight at *{s}*",
        "walk_from": "🚶 Walk ~{d} km to your destination",
        "drive_road": "• {road}",
        "drive_unnamed": "• Continue ({type}{mod})",
        "drive_summary": "🛣 {km} km · ~{min} min drive",
        "view_rail_map": "🗺 View the rail route on map: {link}",
        "commute_note_transit": "_Weather checked along the straight-line corridor between origin and destination; the map link shows the actual rail line (official data.gov.my GTFS)._",
        "start_welcome": "⛈ *Welcome to ThunderWatch MY!*\nYour AI thunderstorm companion for Malaysia. 🇲🇾\n\n*What I can do:*\n📍 *Storm check* — share your location and I'll find the nearest thunderstorm risk, with distance, direction, and advice\n🚦 `/commute Gombak | KL Sentral` — weather along your route for 🏍/🚗/🚆, with step-by-step directions and a mode-switch suggestion if heavy rain hits\n🔔 `/watch` — I re-check your location every 10 minutes and alert you *proactively* when storm risk crosses the threshold\n🗺 Live dashboard — real radar imagery + hourly forecast map, links in every reply\n🇲🇾 `/bm` — tukar ke Bahasa Melayu\n\nStart by sharing your location, or try `/commute Gombak | KL Sentral`.",
    },
    "bm": {
        ...
        "walk_to": "🚶 Berjalan ~{d} km ke *{s}*",
        "board_rail": "🚆 Naik *{line}* menghala *{toward}*",
        "ride_stops": "↳ {n} stesen: {stops}",
        "alight": "⏹ Turun di *{s}*",
        "walk_from": "🚶 Berjalan ~{d} km ke destinasi anda",
        "drive_road": "• {road}",
        "drive_unnamed": "• Teruskan ({type}{mod})",
        "drive_summary": "🛣 {km} km · ~{min} min pemanduan",
        "view_rail_map": "🗺 Lihat laluan kereta api di peta: {link}",
        "commute_note_transit": "_Cuaca disemak sepanjang koridor garis lurus antara asal dan destinasi; pautan peta menunjukkan laluan kereta api sebenar (GTFS rasmi data.gov.my)._",
        "start_welcome": "⛈ *Selamat datang ke ThunderWatch MY!*\nTeman ribut petir AI anda untuk Malaysia. 🇲🇾\n\n*Yang saya boleh buat:*\n📍 *Semakan ribut* — kongsi lokasi anda dan saya cari risiko ribut petir terdekat, dengan jarak, arah, dan nasihat\n🚦 `/commute Gombak | KL Sentral` — cuaca sepanjang laluan anda untuk 🏍/🚗/🚆, dengan panduan langkah demi langkah dan cadangan tukar mod jika hujan lebat\n🔔 `/watch` — saya semak semula lokasi anda setiap 10 minit dan memberi amaran *secara proaktif* apabila risiko ribut melepasi ambang\n🗺 Papan pemuka langsung — imejan radar sebenar + peta ramalan sejam, pautan dalam setiap balasan\n🇬🇧 `/en` — switch to English\n\nMulakan dengan berkongsi lokasi anda, atau cuba `/commute Gombak | KL Sentral`.",
    },
}
